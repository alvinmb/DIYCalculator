...
MAINLOOP:  JSR     [GETNUM]     # Get 1st 16-bit number (NUMA)
           ...
           JSR     [_SUB]       # Subtract NUMB from NUMA
...
# Name:     _SUB                                                      #
#                                                                     #
# Function: Subtracts one 16-bit UNSIGNED binary numbers from another #
#           and return a 16-bit result in the range 0 through 65,535  #
#                                                                     #
# Entry:    Top of stack                                              #
...
########## Make sure there isn't a borrow out from the MS subtraction
_SB_CHK:   JC      [_SB_RET]    # If carry flag = 1 jump to return
           BLDX     MSG_002     # Load X reg with addr of message

...
# Name:     _ADD                                                      #
#                                                                     #
# Function: Add two 16-bit UNSIGNED binary numbers together and       #
#           return a 16-bit result in the range 0 through 65,535      # 
#                                                                     #
# Entry:    Top of stack                                              #
...
########## Make sure there isn't a carry out from the MS addition

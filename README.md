...
**Current version: 7.0.2** — see [RELEASE_NOTES.md](RELEASE_NOTES.md) for what's changed, and [VERSIONING.md](VERSIONING.md) for how version numbers are managed and released.
...
- **Raspberry Pi / Debian**: `sudo dpkg -i beboputer_7.0.2_all.deb && sudo apt-get install -f` (see `bin/beboputer_v7/RPI_INSTALL/README.txt` for details and an alternate one-shot install script).
